                        ...
                        <div class="space-y-1">
                            <div v-if="isEdit">
                                ...
                                <p class="text-sm font-medium leading-5 text-gray-400">
                                    Editing existing coordinator </p>
                            </div>
                            <div v-else>
                                <h1 class="text-2xl text-white pb-2">Create Coordinators</h1>
                                <p class="text-sm font-medium leading-5 text-gray-400">
                                    Create one or multiple coordinators with employee or admin roles</p>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="space-y-2 flex-1">
                                ...
                                <div v-if="isEdit">
                                    <p class="block text-lg font-bold leading-4 tracking-wide uppercase text-gray-600">
                                        {{ coordinatorData.user.full_name }}
                                    </p>
                                </div>
                                ...
                                <div v-else>
                                    ...
                                    <vSelect :options="allUsers"
                                             ...
                                             v-model="coordinatorData.selectedUsers"
                                             @search="onType">
                                ...
                                <div class="border border-gray-400 p-2 rounded grid divide-y divide-gray-400">
                                    <label class="flex items-start p-2">
                                        <input class="mt-1 form-radio text-indigo-600"
                                               name="role"
                                               type="radio"
                                               v-model="coordinatorData.role"
                                               value="employee"/>
                                        <div class="ml-3 text-gray-700 font-medium">
                                            <p>Employee</p>
                                            <small class="text-indigo-700">Can monitor and review supervisors.</small>
                                        </div>
                                    </label>
                                    ...
                                    <label class="flex items-start p-2">
                                        ...
                                        <div class="ml-3 text-gray-700 font-medium">
                                            ...
                                            <small class="text-indigo-700">
                                                Can create/edit/delete coordinators
                                            </small>
                                        </div>
                                    </label>
                                </div>
    ...
    created() {
        this.eventHub.$on(eventNames.createCoordinators, (coordinator) => {
            if (coordinator !== undefined) {
                ...
                this.coordinatorData.selectedUsers = [{id: coordinator.user.id}];
                this.coordinatorData.user = coordinator.user;
                this.isEdit = true;
            } else {
